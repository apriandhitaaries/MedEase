...
<body>
  ...
  <main>
    <!-- hero-area start -->
    <section class="breadcrumb-bg" style="padding-bottom: 180px; padding-top: 143px;" data-background="img/page/page-bg.jpg">
      <div class="container">
        <div class="row">
            ...
            <div class="page-breadcumb">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Cek Antrean</li>
                </ol>
              </nav>
            </div>
          </div>
                ...
                <div class="calculate-box white-bg" style="border-radius: 60px;">
                    <div class="calculate-content">
                        <div class="about-title news-letter-title mb-70">
                            <h5 class="pink-color" style="color: #1669AD;">Cek Antrean</h5>
                            <h1>Cek Nomor Antrean</h1>
                        </div>
                        ...
                        <form class="calculate-form appointment-form-3 mb-20" action="/cek-antrean" method="post">
                            @csrf
                        ...
                        @endif
                            ...
                            <button type="submit" class="btn" style="padding: 24px 249px; margin-left: -60px; margin-bottom: 0px; margin-top: 40px; border-radius: 0 0 15px 15px;">Cari Nomor Antrean</button>
                        </form>
