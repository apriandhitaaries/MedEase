                        ...
                        <div class="page-breadcumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Batal Daftar</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="calculate-box white-bg" style="border-radius: 60px;">
                    <div class="calculate-content">
                        <div class="about-title news-letter-title mb-70">
                            <h5 class="pink-color" style="color: #1669AD;">Batal Daftar</h5>
                            <h1>Batal Daftar Antrean</h1>
                        </div>
                        ...
                        <form class="calculate-form appointment-form-3 mb-20" action="/cek-batal" method="post">
                            @csrf
                            ...
                            <button type="submit" class="btn" style="padding: 24px 240px; margin-left: -60px; margin-bottom: 0px; margin-top: 40px; border-radius: 0 0 15px 15px;">Batal Daftar Antrean</button>
                        </form>
