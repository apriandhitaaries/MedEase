          ...
          <div class="col-xl-6 col-lg-7">
            <div class="about-right-side pt-55 mb-30">
              <div class="about-title mb-20">
                <h1>Cek Antrean & Batal Daftar.</h1>
              </div>
              <div class="about-text">
                <p style="text-align: justify;">
                  "Cek Antrean" adalah fasilitas yang disediakan oleh website puskesmas untuk memungkinkan pasien atau
                  pengunjung memeriksa status atau posisi mereka dalam antrian layanan kesehatan.
                </p>
                <p style="text-align: justify;">
                  "Batal Daftar" adalah opsi yang diberikan kepada pasien untuk membatalkan atau mengubah janji temu
                  atau pendaftaran mereka untuk menerima layanan kesehatan di puskesmas.
                </p>
                <br />
                <h5 style="text-align: center; color: #223645;">
                  Silahkan pilih opsi yang ingin anda lakukan.
                </h5>
                <br>
              </div>
              <div>
                <a data-animation="fadeInLeft" data-delay=".6s" href="/antrean"
                  class="btn btn-panjang d-flex"><span>+</span>CEK ANTREAN</a>
                <br>
                <a data-animation="fadeInLeft" data-delay=".6s" href="/bataldaftar"
                  class="btn-cancel btn-panjang-cancel d-flex"><span>+</span>BATAL DAFTAR</a>
        ...
        <div class="row">
          ...
          <div class="col-xl-6 col-lg-5 d-none d-lg-block">
            <div class="section-button text-right pt-80">
              <a data-animation="fadeInLeft" data-delay=".6s" href="/artikel"
                class="btn btn-icon ml-0"><span>+</span>Artikel Kami</a>
            </div>
          </div>
        </div>
            ...
            <div class="col-xl-5 col-lg-6 col-md-8">
              <div class="footer-contact-info mb-30">
                ...
                <div class="footer-contact-content mb-25">
                  <p>MedEase merupakan aplikasi pendaftaran secara online untuk fasilitas kesehatan Puskesmas Polowijen
                    yang berada di Kota Malang. Kami melayani anda dengan sepenuh hati!</p>
                </div>
                <div class="footer-emailing">
                  <ul>
                    <li><i class="far fa-envelope"></i>info@example.com</li>
                    <li><i class="far fa-clone"></i>https://www.medease.com</li>
                    <li><i class="far fa-flag"></i>Jl. Raden Panji Suroso No.9, Polowijen, Kec. Blimbing, Kota Malang,
                      Jawa Timur 65126</li>
                  </ul>
                </div>
              </div>
