...
<html class="no-js" lang="zxx">
  ...
  <!-- header end -->
      <main>
            <?php
            $nomor_sederhana = substr($nomor_antrean, -3);
            ?>
<!-- hero-area start -->
<section class="breadcrumb-bg pos-rel pt-50 pb-180" style="background-color: #94cfff;">
    <div class="container">
        <div class="row">
            <div class="col-xl-7 col-lg-6 offset-xl-3">
                <div class="calculate-box white-bg" style="border-radius: 60px; padding: -60px;">
                    <div class="calculate-content">
                        <div class="about-title news-letter-title mb-4">
                            <h5 class="pink-color" style="color: #1669AD;">Data Pasien</h5>
                            <h1>MedEase</h1>
                        </div>

                        <div class="data-pasien mb-4">
                            <h4>Nama Pasien</h4>
                            <p>{{ $nama }}</p>
                        </div>

                        <div class="nomor-antrean mb-4">
                            <h4>Nomor Antrean</h4>
                            <p>{{ $nomor_sederhana }}</p>
                        </div>
                        ...
                        <!-- Tambahan: tombol kembali atau tindakan lainnya -->
                        <a href="/antrean" class="btn btn-primary" style="padding: 24px 335px; margin-left: -60px; margin-bottom: 0px; margin-top: 40px; border-radius: 0 0 15px 15px;">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
