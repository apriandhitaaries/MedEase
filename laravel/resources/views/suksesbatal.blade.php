                ...
                <div class="row">
                    <div class="col-lg-9 col-md-9 col-12">
                        <div class="page-title">
                            ...
                            <h1>Pembatalan Pasien Berhasil</h1>
                        </div>
                        <a href="/bataldaftar" class="btn btn-primary" style="padding: 24px 100px; margin-bottom: 0px; margin-top: 40px; border-radius: 15px;">Kembali</a>
