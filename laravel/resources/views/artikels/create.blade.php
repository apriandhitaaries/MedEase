                ...
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('artikels.store') }}" enctype="multipart/form-data">
                        ...
                        @enderror
                            ...
                            <div class="mb-3">
                                <label for="konten" class="form-label">{{ __('Konten') }}</label>
                                <textarea id="konten" class="form-control @error('konten') is-invalid @enderror"
                                    name="konten" rows="4" required>{{ old('konten') }}</textarea>
