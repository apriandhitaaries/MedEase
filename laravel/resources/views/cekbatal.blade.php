...
<html class="no-js" lang="zxx">
  ...
  <!-- header end -->
      <main>
<!-- hero-area start -->
<section class="breadcrumb-bg" style="padding-bottom: 180px; padding-top: 315px;" data-background="img/appoinment/appointment-bg.jpg">
        <div class="container">
            <div class="row">
                    ...
                    <div class="calculate-box white-bg" style="border-radius: 60px;">
                        <div class="calculate-content">
                            <div class="about-title news-letter-title mb-70">
                                <h5 class="pink-color" style="color: #1669AD;">Konfirmasi Pembatalan</h5>
                                <h1>Konfirmasi Pembatalan Antrean</h1>
                            </div>

                            <form class="calculate-form appointment-form-3 mb-20" action="{{ route('batalkan-pendaftaran', $pasien->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <h5 style="margin-bottom: 20px; margin-top: 10px; margin-left: 30px; color: #1669AD;">Apakah Anda yakin ingin membatalkan pendaftaran?</h5>

                                <button type="submit" class="btn" style="padding-right:220px; padding-left:220px; margin-bottom: 0px; margin-top: 20px; border-radius:15px;">Ya, Batalkan</button>
                            </form>

                            <a href="/bataldaftar" class="btn" style=" margin-bottom: 60px; margin-top: 0px; border-radius:15px;">Tidak, Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
